    ...
    @foreach ($cartCollection as $item)
        <div class="row p-2 bg-white border rounded" >
            <div class="col-md-2 mt-1">
                <img class="img-fluid img-responsive rounded product-image" src="{{$item->attributes->image }}" style="  margin: 10px;
    ...
    <div class="row justify-content-end">
        @if (count($cartCollection) > 0)
            <div class="col-lg-5">
                ...
                <a href={{ route('venta.checkout') }} class="btn btn-success">Proceder al Checkout</a> </div>
